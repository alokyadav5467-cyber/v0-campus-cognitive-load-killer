...
export default function DashboardPage() {
  return (
    <div className="space-y-8">
      ...
      <Card className="border-border bg-card/50 backdrop-blur-sm p-6 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
      ...
      {/* Today's Schedule */}
      <Card className="border-border bg-card/50 backdrop-blur-sm p-6 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
